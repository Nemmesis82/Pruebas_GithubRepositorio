...
public class ClienteRs {
	...
	public static void main(String[] args) {
		...
		WebResource webResource1 = client1.resource("http://localhost:8090/WebServiceRest/rest/equipo/");
		...
		WebResource webResource2 = client2.resource("http://localhost:8090/WebServiceRest/rest/equipo/");
