	...
	public static void main(String[] args) 
	{
		...
		String expresion_regular_mails2 = "[\\*\\*\\*]{1}[\\S]+@[\\S]+/{3}";
			...
			if (linea.matches(expresion_regular_mails))//¿Se ajusta linea al patrón descrito por la expresion_regular_mails?
				...
				{
					System.out.println("La linea No contiene la expresión regular descrita");
				}
		
			String[] devolucion = linea.split(expresion_regular_mails2);
			
			//Troceame en subcadenas, la cadena linea, usando como separador la expresión regular dada
