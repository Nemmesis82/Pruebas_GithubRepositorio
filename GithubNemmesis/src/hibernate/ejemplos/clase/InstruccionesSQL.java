...
public class InstruccionesSQL
{
	...
	//public static String buscaruser = "SELECT * from users Where USER_NAME='Ruth', USER_PASS='Nemmesis82'";

	public static String buscarUsuario()
	{
		return "SELECT * from users Where USER_NAME='Ruth' AND USER_PASS='Nemmesis82'";
